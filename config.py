...
LOGGER_ID = int(getenv("LOGGER_ID", -1003460741460))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 8321938136))
...
API_KEY = getenv("API_KEY", '30DxNexGenBotsd2550c')
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/internalxfeelings")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/jnr858.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/jnr858.jpg"
)
